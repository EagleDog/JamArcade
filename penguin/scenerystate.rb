class SceneryState < Omega::State
    ...
    def load
        # Load hills mask
        @hills_mask = Omega::Sprite.new("assets/sceneries/bg_hills_mask.png")
        ...
        15.times do |i|
            if @penguin_range.member?(i)
                @sprites << Omega::Sprite.new("assets/sceneries/mini_penguin.png")
            elsif @flying_bat_range.member?(i)
                @sprites << Omega::Sprite.new("assets/sceneries/flying_bat.png")
            end
        ...
        @witchs = []
        5.times do |i|
            @witchs << Omega::Sprite.new("assets/sceneries/witch_penguin.png")
        ...
        # The vortex
        @vortex = Gosu::Image.new("assets/sceneries/vortex.png")
        @vortex_angle = 0
        @vortex_scale = 0
