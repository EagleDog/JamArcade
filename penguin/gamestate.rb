class GameState1 < Omega::State
    ...
    def load
        ...
        # Moon
        @moon = Omega::Sprite.new("assets/moon.png")
        @moon.y = 15
        @moon.x = Omega.width
        ...
        # Load map
        @map = Omega::Map.new("assets/tileset.png", 32)
        @map.load_layer("solid", "assets/map/map_1.csv")
        ...
        # UI
        @ui_head = Omega::Sprite.new("assets/ui_head.png")
