...
class EndPlayer < Chingu::GameObject
  def setup
    @image = Gosu::Image["relax/assets/characters/knight_left.png"]
  end
  def draw
...
#          @end_player = EndPlayer.create(:x => 300, :y => 110, :zorder => Z::PLAYER)
  ...
  def draw
    Gosu::Image["relax/assets/living_room.png"].draw(0, 0, 0)    # Background Image: Raw Gosu Image.draw(x,y,zorder)-call
    super
  end
end
